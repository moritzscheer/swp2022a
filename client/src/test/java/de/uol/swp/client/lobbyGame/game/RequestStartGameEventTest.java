...
public class RequestStartGameEventTest {
    ...
    private final LobbyDTO lobbyDTO = new LobbyDTO(123,"testLobby",loggedInUser,"pw",true,uuid);

    @Test
    public void testConstructorAndGetters() {
        RequestStartGameEvent event = new RequestStartGameEvent(numberBots, numberCheckpoints, lobbyDTO);
