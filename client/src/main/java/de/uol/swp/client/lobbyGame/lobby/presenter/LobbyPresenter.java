...
public class LobbyPresenter extends AbstractPresenter {
    ...
    /**
     * Method called when the input key "enter" is pressed
     *
     * @param actionEvent The ActionEvent generated by pressing the enter button on the keyboard
     * @author Moritz Scheer and Maria
     * @since 2022-12-08
     */
    @FXML
     ...
     * @param message on NewTextChatMessageReceived
     * @since 2023-01-05
     */
    @Subscribe
    ...
    /**
     * getter method to get the users as an observableList
     *
     * @author Jann Bruns
     * @return users
     * @since 2023-05-15
