...
public class SceneManager {
    ...
    private void initAccountOptionsView() throws IOException {
        if(changeAccountOptionsScene == null) {
            ...
            changeAccountOptionsScene = rootPane;
        }
    }
