...
class UserMessageSerializableTest {
    ...
    void testUserMessagesSerializable() {
        ...
        assertTrue(
                SerializationTestHelper.checkSerializableAndDeserializable(
                        new RegistrationExceptionMessage("Error"),
                        RegistrationExceptionMessage.class));
        assertTrue(
                SerializationTestHelper.checkSerializableAndDeserializable(
                        new LoginSuccessfulResponse(defaultUser, null), LoginSuccessfulResponse.class));
        assertTrue(
                SerializationTestHelper.checkSerializableAndDeserializable(
        ...
        assertTrue(
                SerializationTestHelper.checkSerializableAndDeserializable(
                        new DropUserExceptionMessage("Error"), DropUserExceptionMessage.class));
        assertTrue(
                SerializationTestHelper.checkSerializableAndDeserializable(
                        new UpdateUserExceptionMessage("Error"), UpdateUserExceptionMessage.class));
    }
}
