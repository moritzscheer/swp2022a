...
public class BotPlayerTest {
     ...
     *
     * @author WKempel
     * @result The constructor should create a BotPlayer with the given parameters like the
     *     username, email, password, robotID, position and direction
     * @since 2023-06-23
     */
    @Test
     ...
     *
     * @author WKempel
     * @result The constructor should create two BotPlayers with the given parameters like the
     *     username, email, password, robotID, position and direction
     * @since 2023-06-23
     */
    @Test
