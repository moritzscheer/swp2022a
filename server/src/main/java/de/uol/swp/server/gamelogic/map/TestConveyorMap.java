            ...
            for(x = 0; x<=11; x++){
                ...
                if(!express) {
                    generateBlock(map, x, y,
                            new ConveyorBeltBehaviour(null, map, new Position(x, y), arrowType, direction));
                }
                else{
                    generateBlock(map, x, y,
                            new ExpressConveyorBeltBehaviour(null, map, new Position(x, y), arrowType, direction));
                }
